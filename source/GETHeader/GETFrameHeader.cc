...
ULong_t GETFrameHeader::GetFrameSkip()                 { return GetFrameSize() - sizeof(GETFrameHeader); }
 UInt_t GETFrameHeader::GetHeaderSkip()                { return GetHeaderSize() - sizeof(GETFrameHeader); }
